...
static mender_err_t mender_download_artifact_callback(mender_http_client_event_t event, void *data, size_t data_length);

mender_err_t
mender_download_artifact(mender_deployment_data_t *deployment_data, mender_update_module_t **update_module) {
    assert(NULL != uri);
...
static mender_err_t
mender_download_artifact_callback(mender_http_client_event_t event, void *data, size_t data_length) {
