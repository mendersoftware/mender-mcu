...
typedef struct {
    ...
    uint16_t backoff_interval;          /**< Backoff interval for retries on retry errors, default is compile-time defined */
    uint16_t max_backoff_interval;      /**< Max backoff interval for retries on retry errors, default is compile-time defined */
