 ...
 * @brief     Mender HTTP client event type (private API)
 *
...
#ifndef __MENDER_HTTP_CLIENT_EVENT_PRIV_H__
#define __MENDER_HTTP_CLIENT_EVENT_PRIV_H__
...
#endif /* __MENDER_HTTP_CLIENT_EVENT_PRIV_H__ */
