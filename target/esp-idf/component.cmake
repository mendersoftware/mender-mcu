...
idf_component_register(
    ...
    PRIV_REQUIRES ${MENDER_ESP_IDF_COMPS}
...
if(CONFIG_MENDER_SECONDARY_SERVER_HOST_DISABLE)
    target_compile_definitions(${COMPONENT_LIB} PUBLIC CONFIG_MENDER_SECONDARY_SERVER_HOST_DISABLE)
endif()
if(CONFIG_MENDER_MAX_STATE_DATA_STORE_COUNT)
    target_compile_definitions(${COMPONENT_LIB} PUBLIC CONFIG_MENDER_MAX_STATE_DATA_STORE_COUNT=${CONFIG_MENDER_MAX_STATE_DATA_STORE_COUNT})
endif()
...
if(DEFINED CONFIG_MENDER_SECONDARY_SERVER_HOST)
    target_compile_definitions(${COMPONENT_LIB} PRIVATE CONFIG_MENDER_SECONDARY_SERVER_HOST=\"${CONFIG_MENDER_SECONDARY_SERVER_HOST}\")
endif()
