...
#### Design note ###
#
# Ideally, we would have use existing hook from Zephyr project to trigger the
...
# and there is no way to "sort" the command or declare interdepencies betwen
# them.
#
# So here is the workaround: as a post build command just remove the Artifact,
# so that we clear an stale Artiact every time that we build a new kernel. And
...
add_custom_target(
    ...
    echo "Generating Mender Artifact from ${mender_artifact_payload} for board ${BOARD}" &&
    ${mender_artifact_cmd} 
    DEPENDS
